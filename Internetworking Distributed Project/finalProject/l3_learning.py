  ...
  def _handle_PacketIn (self, event):
    ...
    if isinstance(packet.next, ipv4):
      ...
      msg = of.ofp_flow_mod(command = of.OFPFC_ADD,
                            ...
                            match=of.ofp_match(dl_type = pkt.ethernet.IP_TYPE, nw_proto = pkt.ipv4.TCP_PROTOCOL, nw_src="192.168.0.0/16"))
      event.connection.send(msg.pack())

     # if str(packet.next.tos)=="0":
     #   log.info("ToS is 0 on this packet")
     #   msg = of.ofp_flow_mod(command = of.OFPFC_ADD,
     #                         idle_timeout=of.OFP_FLOW_PERMANENT,
     #                         hard_timeout=of.OFP_FLOW_PERMANENT,
     #                         action=of.ofp_action_output(port = 0),
